...
#+texinfo: @heading Fallback fonts
...
In this case, you document uses a document class, which like most,
LaTeX document classes use the ~lm...~. These fonts
are installed with your LaTeX distribution. Most of the times,
...
it will include the following fallback definition for the ~main~
font[fn:55]:
...
#+texinfo: @heading Additional settings
