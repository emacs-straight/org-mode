...
and ~FONT~ is the system font name for that script.
...
#+BEGIN_SRC elisp :results none :exports code
(setq org-latex-babel-fontspec
      '(("de"
         :fonts (("rm" . "CMU Serif")))
        ("el-polyton"
         :fonts (("rm" . "Noto Serif")))
        (nil
         :fonts (("tt" . "DejaVu Sans Mono")))))
#+END_SRC
...
Sans Mono~ regardless of the language.
